...
public class proceduralMarteSonda {
	...
	public static void main(String[] args)
	{
		...
		//Solicitado para que o usuário informe s localicação inicial da 1ª Sonda, devendo informar as posições de x, y e direção cardial.
		...
		//Solicitado para que o usuário informe s localicação inicial da 2ª Sonda, devendo informar as posições de x, y e direção cardial.
		System.out.print("Informe a localização de x: ");
		x2 = ler.nextInt();
		System.out.print("Informe a localização de y: ");
		y2 = ler.nextInt();
